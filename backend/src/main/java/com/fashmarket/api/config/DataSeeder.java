...
public class DataSeeder implements CommandLineRunner {
    ...
    public DataSeeder(ProductoRepository productoRepository, BannerRepository bannerRepository, UsuarioRepository usuarioRepository) {
    ...
    private void crearAdmin() {
        if (!usuarioRepository.existsByCorreoIgnoreCase(adminCorreo)) {
            Usuario admin = new Usuario(adminNombre, adminCorreo.toLowerCase(), adminPassword, Rol.ADMIN);

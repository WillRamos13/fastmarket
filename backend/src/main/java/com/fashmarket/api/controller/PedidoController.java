...
public class PedidoController {
    ...
    public List<PedidoDtos.PedidoResponse> listarPorUsuario(@PathVariable Long usuarioId) {
        return pedidoService.listarPorUsuario(usuarioId);
    }

    @PostMapping("/usuario/{usuarioId}")
    public PedidoDtos.PedidoResponse crear(@PathVariable Long usuarioId, @Valid @RequestBody PedidoDtos.CrearPedidoRequest request) {
        return pedidoService.crear(usuarioId, request);
    }

    @PutMapping("/{pedidoId}/estado")
    public PedidoDtos.PedidoResponse actualizarEstado(@PathVariable Long pedidoId, @RequestParam EstadoPedido estado) {
